  ...
  'inline-flex items-center rounded-md px-2.5 py-0.5 text-xs font-medium transition-colors focus:outline-none focus:ring-2 focus:ring-ring focus:ring-offset-2',
  {
    variants: {
      variant: {
        ...
        electric: 'border-transparent bg-electric-600 text-white shadow-sm hover:bg-electric-700',
        skill: 'border border-electric-200 bg-electric-50 text-electric-800 hover:bg-electric-100 dark:border-electric-800 dark:bg-electric-900/30 dark:text-electric-300',
      },
    },
    defaultVariants: {
      variant: 'default',
